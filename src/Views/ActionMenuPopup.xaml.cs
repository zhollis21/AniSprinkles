...
/// <summary>
/// The per-entry action a user picked from the My Anime long-press menu. The popup is a pure
/// router — each value maps to an existing dedicated flow in <c>MyAnimePageModel</c>.
/// </summary>
