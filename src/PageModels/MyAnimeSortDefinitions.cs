...
/// <summary>
/// The canonical My Anime sort rows as <c>(Code, Display)</c> pairs, where <c>Code</c> is "Field:dir"
...
/// guard backing the runtime tripwire in <see cref="MyAnimePageModel.SelectSort"/>: the picker should only
/// ever emit valid codes, and this keeps that true. <see cref="MyAnimePageModel.SortOptions"/> wraps these
/// into fresh <see cref="SortOption"/> objects so the mutable IsSelected highlight is never shared.
/// </summary>
public static class MyAnimeSortDefinitions
{
