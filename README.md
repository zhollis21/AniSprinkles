...
- **Search** — debounced search across all of AniList on its own tab, with an Anime/Manga toggle and infinite scrolling; works signed-out, and shows your list status on every result when signed in
