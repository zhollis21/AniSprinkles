...
/// suppressed: page-model navigate commands call <see cref="ShouldSuppressTap"/> first.
/// </summary>
public sealed class CollectionViewLongPress
{
    ...
    /// <summary>
    /// True when a long-press fired within the last 800 ms — the synthetic tap that follows the
    /// finger-up of that long press (and would otherwise navigate underneath the action sheet).
    /// </summary>
    public static bool ShouldSuppressTap()
        => Environment.TickCount64 - Interlocked.Read(ref _lastLongPressTicks) < 800;
        ...
        AndroidX.RecyclerView.Widget.RecyclerView.IOnItemTouchListener
    {
        ...
        public bool OnInterceptTouchEvent(AndroidX.RecyclerView.Widget.RecyclerView rv, Android.Views.MotionEvent e)
        {
                ...
                && e.Action is Android.Views.MotionEventActions.Up or Android.Views.MotionEventActions.Cancel)
            {
                ...
                Interlocked.Exchange(ref _lastLongPressTicks, Environment.TickCount64);
            }
