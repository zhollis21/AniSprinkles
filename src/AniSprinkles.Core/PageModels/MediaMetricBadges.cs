...
public static class MediaMetricBadges
{
    public static ItemMetricBadge? ForMediaSort(RelatedMedia? media, string sort)
    {
        ...
        return sort switch
        {
            ...
            {
                Glyph = MediaFormatIcons.GlyphFor(media.Format) ?? Glyphs.Regular.MoviesAndTv24,
