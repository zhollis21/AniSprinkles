...
- Always read `docs/PLAN.md`, `docs/TODO.md`, `docs/DEBUGGING.md`, `docs/BestPractices-MAUI-Android.md`, and `README.md` at the start of a session.
- Always follow repository `.editorconfig` standards for formatting, style, and naming.
- Follow best practices for code comments
- Prefer comments that explain why (intent, tradeoffs, guardrails), not just what the code is doing.
...
- Keep `docs/PLAN.md`, `docs/TODO.md`, `docs/DEBUGGING.md`, `docs/BestPractices-MAUI-Android.md`, and `README.md` up to date when we make decisions or discuss changes that warrant updates.
